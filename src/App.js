...
import './App.scss';
import Categoriesdecision from './Components/Categories/Categoriesdecision.js';
import {
            ...
            <Switch>
              <Route exact path = '/'>
                <HomePage showCategories={this.showCategories} />
  				   ...
  				   <Route exact path='/Categoriesdecision' component={()=><Categoriesdecision product={this.state.product} />}/>
            </Switch>
