	    ...
	    <p className="gray f4">[Our portfolio]</p>
         {
						...
						.map((item) => {
			               ...
			               <h1 data-aos="fade-left" data-aos-duration="1000">{item.Client}</h1>
				               ...
				               <Link to='/projectview' onClick={() => setProject(item)}><button className="butt" data-aos="fade-left" data-aos-duration="1000" data-aos-offset="150">View Project</button></Link>
